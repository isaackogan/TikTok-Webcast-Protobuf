...
function createBaseUser(): User {
  return {
    ...
    secUid: "",
    userRole: 0,
    deprecated9: Buffer.alloc(0),
    activityReward: undefined,
    deprecated10: Buffer.alloc(0),
    deprecated11: Buffer.alloc(0),
    personalCard: undefined,
    authenticationInfo: undefined,
    deprecated12: 0,
    deprecated13: 0,
    deprecated14: Buffer.alloc(0),
    mediaBadgeImageList: [],
    deprecated15: 0,
    userVipInfo: Buffer.alloc(0),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 48: {
          ...
          message.deprecated9 = Buffer.from(reader.bytes());
          continue;
        }
        case 49: {
          if (tag !== 394) {
        ...
        case 50: {
          ...
          message.deprecated10 = Buffer.from(reader.bytes());
          continue;
        }
        case 51: {
          if (tag !== 410) {
          ...
          message.deprecated11 = Buffer.from(reader.bytes());
          continue;
        }
        case 52: {
          if (tag !== 418) {
        ...
        case 56: {
          ...
          message.deprecated14 = Buffer.from(reader.bytes());
          continue;
        }
        case 57: {
          if (tag !== 458) {
        ...
        case 59: {
          ...
          message.userVipInfo = Buffer.from(reader.bytes());
          continue;
        }
        case 60: {
          if (tag === 480) {
        ...
        case 1041: {
          ...
          message.stats = Buffer.from(reader.bytes());
          continue;
        }
        case 1042: {
          if (tag !== 8336) {
